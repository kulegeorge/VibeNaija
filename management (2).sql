...
(15, 'A call from Abel on our 3rd  Wedding Anniversary', 45, '20251210090214Transaction Receipt-251210010100265488888036.pdf', '', '', 'George Kule', '2025-12-10 20:02:14', '2025-12-10 20:02:14');
...
(45, 'A call from Abel', '2025-12-10', '2025-12-11', '2025-12-10 19:55:36', '2025-12-10 19:55:36');
...
(37, '2025_12_03_043752_create_task_unenrolls_table', 10);
...
--
-- Table structure for table `task_unenrolls`
--

CREATE TABLE `task_unenrolls` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `task_unenrolls`
--

INSERT INTO `task_unenrolls` (`id`, `task_id`, `user_id`, `reason`, `created_at`, `updated_at`) VALUES
(5, 9, 9, 'Any reason', '2025-12-03 14:56:24', '2025-12-03 14:56:24'),
(6, 9, 9, 'Any reason', '2025-12-03 16:17:48', '2025-12-03 16:17:48');
...
--
-- Indexes for table `task_unenrolls`
--
ALTER TABLE `task_unenrolls`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `task_unenrolls`
--
ALTER TABLE `task_unenrolls`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
