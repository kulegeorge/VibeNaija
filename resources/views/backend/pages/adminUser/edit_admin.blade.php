          ...
          <div class="col-md-11 col-xl-11 middle-wrapper">
            ...
            <div class="card">
              <div class="card-body">
								...
								<form id="myForm" method="POST" action="{{route('update.admin', $userID->id)}}" class="forms-sample">
                                    @csrf
                                    ...
                                    <div class="col-sm-6">
                                       <div class="mb-3">
                                        ...
                                        <option value="{{$userID->title}}">{{$userID->title}}</option>
...
<option value="Sis">Sis.</option>
                                       ...
                                       <div class="mb-3">
										...
										<input type="text"  name="name" class="form-control" id="adminName" value="{{$userID->name}}">
...
<div class="col-sm-6">
                                    ...
                                    <div class="mb-3">
										...
										<input type="email"  name="email" class="form-control" id="email" value="{{$userID->email}}">
...
<div class="col-sm-6">
                                    ...
                                    <div class="mb-3">
										...
										<input type="text"  name="phone" class="form-control" id="phone" value="{{$userID->phone}}">
...
<div class="col-sm-6">
                                    <div class="mb-3">
										...
										<input type="text"  name="address" class="form-control" id="address" value="{{$userID->address}}">
...
<div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <option selected value="{{$userID->location}}">{{$userID->location}}</option>
...
<div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <option value="{{$role->id}}" {{$userID->hasRole($role->name) ? 'selected': ''}} >{{$role->name}}</option>
                                        @endforeach
                                    </select>
                                    </div>
