            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-md-6 col-md-push-6">
                    <div class="sign-in-area">
                        ...
                        <form class="form mb50" method="POST" action="{{ route('login') }}">
        @csrf
                            <div class="form-group">
                                <div class="form-icon icon-user">
                                    <input type="text" name="login" required class="form-control" placeholder=" Name|Phone|Email Name">
                                </div>
                            ...
                            <label class="form-remember">
                                <input type="checkbox" name="remember" id="remember_me"> Remember Password </label>

                            <a href="{{ route('password.request') }}" class="forgot"><small>Forgot your password?</small></a>

                            <div>
                                <button type="submit" class="btn btn-d"> Sign In </button>
                            </div>
                        </form>
                        ...
                        <p class="mb0">
                            <a href="page_sign_in.html#" class="btn btn-bg br2 btn-icon facebook xs-block"><i class="fa fa-facebook"></i> Facebook</a>
                            <span class="mr10"></span>
                            <a href="page_sign_in.html#" class="btn btn-bg br2 btn-icon twitter xs-block"><i class="fa fa-twitter"></i> Twitter</a>
                            <span class="mr10"></span>
                            <a href="page_sign_in.html#" class="btn btn-bg br2 btn-icon google-plus xs-block"><i class="fa fa-google-plus"></i> Google+</a>
                        </p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-5 col-md-pull-6">
                    <div class="info-area">
                        <div class="box-services-a">
                            <h3 class="title-small"><i class="fa fa-users fa-bg"></i> Join Our Community <a href="page_sign_in.html#" class="link-read-more">read more</a></h3>
                            <p>
