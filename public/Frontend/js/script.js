...
/* *********************	Append HTML and  Set Cookies	  ********************* */
	...
	$('head').append($('<link rel="stylesheet" id="custom-color" href="css/void.css">'));
	$('head').append($('<link rel="stylesheet" id="custom-layout" href="css/void.css">'));
	$('head').append($('<link rel="stylesheet" id="custom-style" href="css/void.css">'));


	$('body').append($('<a href="https://themeforest.net/item/palas-bootstrap-multipurpose-html5-template/10682737?ref=abusinesstheme" class="demo-buy">PURCHASE</a>'));
